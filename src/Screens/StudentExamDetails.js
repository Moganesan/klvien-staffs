...
import ExamsPie from "../Components/ExamsPie";
import ExamsChart from "../Components/ExamsChart";
  ...
  return (
    <>
      <div style={{ display: "flex", justifyContent: "space-between" }}>
        <Breadcrumbs pages={["students", "Exams", exams.firstName]} />
        <Header></Header>
      </div>
      <AttendanceDetailsContainer>
        <AttendanceContainer>
          <div>
            <ExamsPie data={exams.examsData} />
          </div>
          <div>
            <ExamsChart data={exams.examsData.subjects} />
          </div>
        </AttendanceContainer>
        <Table>
          <thead>
          ...
          <tbody>
            {exams.examsData.exams.map((data) => {
              return (
                <tr>
                  <td>{data.subject}</td>
                  <td>{data.title}</td>
        ...
        <Pagination
          ...
          totalData={exams.examsData.exams.length}
          paginate={paginate}
